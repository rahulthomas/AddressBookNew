...
// Java core packages
//import com.deitel.advjhtp1.jdbc.addressbook.AddressBookEntryFrame;
...
public class AddressBook extends JFrame  {
   ...
   public AddressBookEntryFrame createAddressBookEntryFrame()
   {
   ...
   private class SearchAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
        ...
        if (lastName != null ) {
            ...
            System.out.println("Finding person with last name: " + lastName);
            System.out.println("returned " + person);
            if ( person != null) {
               System.out.println("hmmmmm.....not null?");
            ...
            AddressBookEntry person1 = database.findPerson(lastName );

            if ( person1 != null) {
               System.out.println("hmmmmm.....not null?");
               // create window to display AddressBookEntry
               AddressBookEntryFrame entryFrame1 =
                       createAddressBookEntryFrame();

               // set AddressBookEntry to display
               entryFrame1.setAddressBookEntry( person1 );

               // display window
               desktop.add( entryFrame1 );
               entryFrame1.setVisible( true );
