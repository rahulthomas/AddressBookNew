...
*/
   ...
   private void connect() throws Exception
   {
      ...
      String url = "jdbc:mysql://localhost:3306/AddressBook?user=root&password=password1";
   ...
   public AddressBookEntry findPerson(String lastName )
   {
      try {
         ...
         System.out.println("searching for person with last name: " + lastName);
         System.out.println("well " + resultSet.next());
     ...
     //       return null;
       ...
       //  System.out.println("Email ID: " + resultSet.getString(12));
